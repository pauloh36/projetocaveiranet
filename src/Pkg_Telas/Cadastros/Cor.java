...
public class Cor extends javax.swing.JFrame {
    ...
    public Cor() {
        ...
        txCor.setDocument(new TamanhoTextField(0));
    }
    ...
    public String getCor(){
        return cor = txCor.getText().toUpperCase();
    }
    ...
    private void initComponents() {
        ...
        internalCadastraCores = new javax.swing.JInternalFrame();
        ...
        internalCadastraCores.setClosable(true);
        internalCadastraCores.setIconifiable(true);
        internalCadastraCores.setTitle("Cadastra Cores");
        internalCadastraCores.setEnabled(false);
        internalCadastraCores.setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/Pkg_Imagens/cores.png"))); // NOI18N
        internalCadastraCores.setVisible(true);

        jPanel3.setLayout(null);

        jLabel18.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(102, 102, 102));
        jLabel18.setText("Cadastrar Cores");
        jPanel3.add(jLabel18);
        jLabel18.setBounds(110, 10, 160, 30);
        ...
        javax.swing.GroupLayout internalCadastraCoresLayout = new javax.swing.GroupLayout(internalCadastraCores.getContentPane());
        internalCadastraCores.getContentPane().setLayout(internalCadastraCoresLayout);
        internalCadastraCoresLayout.setHorizontalGroup(
            internalCadastraCoresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, 352, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        internalCadastraCoresLayout.setVerticalGroup(
            internalCadastraCoresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(internalCadastraCores, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
...
private void btnIncluirKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnIncluirKeyPressed
    ...
    public void bancoSalva(){
        String msg1 = "Cor Cadastrada com sucesso";
        String msg2 = "Cor Não Cadastrada";
        String sql = "INSERT INTO tb_cor VALUES (null, '"+getCor()+"')";
          bf.salvar(sql, msg1, msg2);
    }

    public void recupera(){
        String sql  = "SELECT * "+
                      "FROM tb_cor order by cor_cor";
        String msg1 = "Cor Recuperada com sucesso";
        String msg2 = "Cor Não recuperada";
        bf.tabelaCadastros(sql,"cor_cod","cor_cor","tb_cor", msg1, msg2, tabela);
    }
...
// Vê se ambos os campos estão vazios...
    ...
    public javax.swing.JInternalFrame internalCadastraCores;
