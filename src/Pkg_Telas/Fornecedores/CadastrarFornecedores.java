...
public class CadastrarFornecedores extends javax.swing.JDialog {
    ...
    public CadastrarFornecedores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(712, 470));
...
//-----    Se componentes estão invisiveis salva no banco--------------------------
    ...
    public void bancoSalvaFisico(){
        String msg1 = "Fornecedor Cadastrado com sucesso";
        String msg2 = "Fornecedor Não Cadastrado";
...
//-------se estiver invisivel altera FLAG ------------
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                CadastrarFornecedores dialog = new CadastrarFornecedores(new javax.swing.JFrame(), true);
