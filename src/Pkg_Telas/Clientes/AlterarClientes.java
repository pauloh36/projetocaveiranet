...
public class AlterarClientes extends javax.swing.JDialog {
    ...
    public AlterarClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//-----    Se componentes estão invisiveis salva no banco--------------------------
    ...
    public void exclui(){
                    Object[] options = { "Sim", "Não" };
                        int opcao = JOptionPane.showOptionDialog(null, "Deseja Excluir Cliente ?", "AVISO",
                                JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);

                        if(opcao == 0){
                                    String msg1 = "Cliente Excluido";
                                    String msg2 = "Erro Ao Excluir Cliente";
                                    String sql = "delete from tb_Clientes WHERE cli_cod='"+getForCod()+"'";
    ...
    public void bancoAtualizaFisico(){
        ...
        String msg1 = "Cliente Alterado com sucesso";
        String msg2 = "Cliente Não Alterado";
        String sql  = "UPDATE tb_clientes SET" +
                      " cli_cod="+getForCod()+"," +
                      " cli_cliente='"+getFornecedor()+"'," +
                      " cli_cnpj=' '," +
                      " cli_cpf='"+getCPF()+"'," +
                      " cli_nomefantasia=' '," +
                      " cli_inscestadual=' '," +
                      " cli_endereco='"+getEndereco()+"'," +
                      " cli_numero='"+getNumero()+"'," +
                      " cli_cep='"+getCep()+"'," +
                      " cli_estado='"+getEstado()+"'," +
                      " cli_bairro='"+getBairro()+"'," +
                      " cli_cidade='"+getCidade()+"'," +
                      " cli_website='"+getWebSite()+"'," +
                      " cli_contato='"+getContato()+"'," +
                      " cli_email='"+getEmail()+"'," +
                      " cli_telefone='"+getTelefone()+"'," +
                      " cli_telefone2='"+getTelefone2()+"'," +
                      " cli_celular='"+getCelular()+"'," +
                      " cli_pessoa='FISICO'" +
                      " WHERE cli_cod='"+getForCod()+"'";
...
//-------se estiver invisivel altera FLAG ------------
    ...
    public void geraRelatorio(){
            ...
            String msg1="Ficha de Cliente gerada";
            String msg2="Erro ao Gerar Ficha de Cliente";
            String sql = "SELECT "+
                         "tb_clientes.`cli_cod` AS tb_clientes_cli_cod, "+
                         "tb_clientes.`cli_cliente` AS tb_clientes_cli_cliente, "+
                         "tb_clientes.`cli_cnpj` AS tb_clientes_cli_cnpj, "+
                         "tb_clientes.`cli_cpf` AS tb_clientes_cli_cpf, "+
                         "tb_clientes.`cli_nomefantasia` AS tb_clientes_cli_nomefantasia, "+
                         "tb_clientes.`cli_inscestadual` AS tb_clientes_cli_inscestadual, "+
                         "tb_clientes.`cli_endereco` AS tb_clientes_cli_endereco, "+
                         "tb_clientes.`cli_numero` AS tb_clientes_cli_numero, "+
                         ...
                         "tb_clientes.`cli_estado` AS tb_clientes_cli_estado, "+
                         "tb_clientes.`cli_website` AS tb_clientes_cli_website, "+
                         "tb_clientes.`cli_contato` AS tb_clientes_cli_contato, "+
                         "tb_clientes.`cli_email` AS tb_clientes_cli_email, "+
                         "tb_clientes.`cli_telefone` AS tb_clientes_cli_telefone, "+
                         "tb_clientes.`cli_telefone2` AS tb_clientes_cli_telefone2, "+
                         "tb_clientes.`cli_celular` AS tb_clientes_cli_celular, "+
                         "tb_clientes.`cli_pessoa` AS tb_clientes_cli_pessoa "+
                         "FROM `tb_clientes` tb_clientes "+
                         "where cli_cod = "+getForCod();
        
            String localRelatorio = System.getProperty("user.dir", "") + "/src/Pkg_Relatorios/fichaCliente.jasper";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                AlterarClientes dialog = new AlterarClientes(new javax.swing.JFrame(), true);
